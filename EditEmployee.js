...
const SubmitHandler = (e) => {
  e.preventDefault();
  axios.put(`http://localhost:4000/employee/${id}`, { name, email, address, number, })
    .then(() => {
      alert("Successfully updated data");
      // navigate("/"); // ✅ Redirect to homepage or student list
setName('');
setEmail('');
setAddress('');
setNumber('');
  ...
  return (
    <section>
      ...
      <div className="p-2 mt-2 mb-3 container">
        <form className="text-start p-3 bg-light rounded shadow"onSubmit={SubmitHandler} >
          <div className="mb-3">
